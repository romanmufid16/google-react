function Header() {
    return (
        <div className="flex justify-end items-center gap-4 p-2">
            ...
            <a href="#" className="text-sm hover:underline">Gambar</a>
            <div className="w-10 hover:bg-gray-200 rounded-full transition-all duration-500 ease-in-out">
                <svg fill="#000000" version="1.1" className="w-fit p-3" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 276.167 276.167">
                    <g>
                        <g>
            ...
            <div className="w-8 h-8 border-2 border-slate-500 hover:border-2 hover:border-gray-300 rounded-full transition-all duration-500 ease-out bg-sky-700 flex justify-center items-center">
